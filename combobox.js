(function ($) {
	$.widget("custom.combobox",
	{
		...
		_create : function() {
			var self = this;
			self.wrapper = $("<span>").addClass("custom-combobox").insertAfter(this.element);
			self.element.hide();
		...
		_createAutocomplete : function() {
			var self = this;
			var selected = self.element.children(":selected");
			var value = selected.val() ? selected.text() : "";
			if(this.options.openToUp) {
				//TODO: tu dajesz ustawienia my i at
			}
			self.input = $("<input>")
		...
		update : function(options) {
			console.log("funkcja update z widgetu");
			console.log(this.options.openToUp);
		}
	});
})(jQuery);