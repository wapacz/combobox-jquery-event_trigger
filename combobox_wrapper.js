(function($) {
	function combobox_wrapper_init() {
    ...
    $.fn.combobox_wrapper = function (method, options) {
        
        /***** Method resolving *****/
		if (typeof method === 'object' || !method) {
            return combobox_wrapper_init.apply(this, arguments);
        } else {
            $.error('Method ' + method + ' does not exist in jQuery.mycombobox');
        }
    };
